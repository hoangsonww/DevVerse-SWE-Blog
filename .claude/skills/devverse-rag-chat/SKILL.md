...
6. Validate chat changes with both tests and manual reasoning about runtime behavior.
Use `devverse-validate` for the automated part, then note any live env checks you could not perform.
