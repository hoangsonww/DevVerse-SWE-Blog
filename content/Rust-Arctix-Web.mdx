...
export const metadata = {
  ...
  description:
    "An extended comprehensive guide to designing, implementing, and deploying high-performance RESTful APIs using Rust and Actix Web. This guide dives deeper into Rust’s concurrency model, middleware, advanced asynchronous programming, error handling, database integration, automated testing, deployment strategies, and performance tuning through a complete CRUD example application.",
  topics: [
    "Backend Development",
    "Rust Programming",
    "Actix Web",
