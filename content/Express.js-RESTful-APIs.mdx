...
export const metadata = {
  ...
  description: "An in-depth guide to creating robust RESTful APIs using Express.js, covering routing, middleware, error handling, and best practices.",
  topics: ["Web Development", "Node.js", "API Design"]
}
