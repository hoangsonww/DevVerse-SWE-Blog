...
export const metadata = {
  ...
  description: "A comprehensive exploration of GraphQL, covering its evolution, architecture, core concepts, and how GraphQL compares to REST and why it is revolutionizing API design.",
